  ...
  <header class="chapter-top-bar header-visible">
    <div class="top-bar-inner">
      ...
      <div class="top-bar-right">
        ...
        <a href="https://github.com/kedar773/physics-app/releases/latest/download/kedars-physics-engine.apk" class="apk-toggle-btn" title="Download Kedar's Physics Engine App (Android APK)" download="kedars-physics-engine.apk">📱 APK</a>
  ...
  <main class="portal-main-wrap">
    ...
    <header class="portal-hero-section">
      ...
      <div class="portal-corner-actions">
        <a href="https://github.com/kedar773/physics-app/releases/latest/download/kedars-physics-engine.apk" class="portal-corner-btn portal-corner-apk" title="Download Kedar's Physics Engine App (Android APK)" download="kedars-physics-engine.apk">
